 ...
 */
class Version20181205220923 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE files (id INT AUTO_INCREMENT NOT NULL, file_type_id INT DEFAULT NULL, created_id INT DEFAULT NULL, updated_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, extension VARCHAR(5) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_63540599E2A35A8 (file_type_id), INDEX IDX_63540595EE01E44 (created_id), INDEX IDX_6354059960CC7F3 (updated_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE file_types (id INT AUTO_INCREMENT NOT NULL, created_id INT DEFAULT NULL, updated_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_F3B339075EE01E44 (created_id), INDEX IDX_F3B33907960CC7F3 (updated_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE files ADD CONSTRAINT FK_63540599E2A35A8 FOREIGN KEY (file_type_id) REFERENCES file_types (id)');
        $this->addSql('ALTER TABLE files ADD CONSTRAINT FK_63540595EE01E44 FOREIGN KEY (created_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE files ADD CONSTRAINT FK_6354059960CC7F3 FOREIGN KEY (updated_id) REFERENCES users (id)');
        ...
        $this->addSql('ALTER TABLE file_types ADD CONSTRAINT FK_F3B339075EE01E44 FOREIGN KEY (created_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE file_types ADD CONSTRAINT FK_F3B33907960CC7F3 FOREIGN KEY (updated_id) REFERENCES users (id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE files DROP FOREIGN KEY FK_63540595EE01E44');
        $this->addSql('ALTER TABLE files DROP FOREIGN KEY FK_6354059960CC7F3');
        ...
        $this->addSql('ALTER TABLE file_types DROP FOREIGN KEY FK_F3B339075EE01E44');
        $this->addSql('ALTER TABLE file_types DROP FOREIGN KEY FK_F3B33907960CC7F3');
        $this->addSql('ALTER TABLE users DROP FOREIGN KEY FK_1483A5E99D419299');
        $this->addSql('ALTER TABLE files DROP FOREIGN KEY FK_63540599E2A35A8');
