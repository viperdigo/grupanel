<?php
namespace Grupanel\BackendBundle\Listener;

use Doctrine\ORM\Event\LifecycleEventArgs;
use Doctrine\ORM\Event\PostFlushEventArgs;
use Doctrine\ORM\Event\PreUpdateEventArgs;
use Grupanel\CoreBundle\Entity\AuditLog;
use Grupanel\CoreBundle\Entity\Customer;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Grupanel\CoreBundle\Entity\CustomerBalanceLog;
use Grupanel\CoreBundle\Entity\CustomerStatusLog;
use Grupanel\CoreBundle\Entity\MaintenanceProduct;
use Grupanel\CoreBundle\Entity\MaintenanceStatusLog;
use Grupanel\CoreBundle\Entity\Payment;
use Grupanel\CoreBundle\Entity\Product;
use Grupanel\CoreBundle\Entity\StorageLog;
...
class DoctrineListener
{
    ...
    private function auditLog($args, $changes = '')
    {
        ...
        if ($v != 'Grupanel' || in_array($c, $this->logClasses)) {
            return;
        }
