 ...
 * @ORM\Entity(repositoryClass="Grupanel\CoreBundle\Repository\CustomerStatusRepository")
 */
class CustomerStatusLog
{
     ...
     * @var Customer
     *
     * @ORM\ManyToOne(targetEntity="Grupanel\CoreBundle\Entity\Customer", inversedBy="statusLogs")
     * @ORM\JoinColumns({
