...
class Product
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Grupanel\CoreBundle\Entity\Supplier")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\OneToMany(targetEntity="Grupanel\CoreBundle\Entity\MaintenanceProduct", mappedBy="product")
     */
    private $maintenance;

    /**
     * @var \Grupanel\CoreBundle\Entity\StorageLog
     *
     * @ORM\OneToMany(targetEntity="Grupanel\CoreBundle\Entity\StorageLog", mappedBy="product")
     */
    private $storageLogs;

    /**
     * @var \Grupanel\CoreBundle\Entity\ProductComponent
     *
     * @ORM\OneToMany(targetEntity="Grupanel\CoreBundle\Entity\ProductComponent", mappedBy="product")
     */
    private $components;
