...
class MaintenanceProduct
{
     ...
     * @var Customer
     *
     * @ORM\ManyToOne(targetEntity="Grupanel\CoreBundle\Entity\Customer", inversedBy="maintenance")
     * @ORM\JoinColumns({
     ...
     * @var Product
     *
     * @ORM\ManyToOne(targetEntity="Grupanel\CoreBundle\Entity\Product", inversedBy="maintenance")
     * @ORM\JoinColumns({
     ...
     * @ORM\OneToMany(targetEntity="Grupanel\CoreBundle\Entity\MaintenanceStatusLog", mappedBy="maintenance")
