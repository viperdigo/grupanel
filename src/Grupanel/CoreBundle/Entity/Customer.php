 ...
 * @ORM\Entity(repositoryClass="Grupanel\CoreBundle\Repository\CustomerRepository")
 */
class Customer
{
    ...
    /**
     * @var \Grupanel\CoreBundle\Entity\MaintenanceProduct
     *
     * @ORM\OneToMany(targetEntity="Grupanel\CoreBundle\Entity\MaintenanceProduct", mappedBy="customer")
     */
    private $maintenance;
     ...
     * @ORM\OneToMany(targetEntity="Grupanel\CoreBundle\Entity\CustomerStatusLog", mappedBy="customer")
    ...
    /**
     * @var Payment
     * @ORM\OneToMany(targetEntity="Grupanel\CoreBundle\Entity\Payment", mappedBy="customer")
     */
    private $payments;

    /**
     * @var Order
     * @ORM\OneToMany(targetEntity="Grupanel\CoreBundle\Entity\Order", mappedBy="customer")
     */
    private $orders;
